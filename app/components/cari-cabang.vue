  ...
  <div class="pb-20">
    ...
    <Teleport to="body">
      ...
      >
        <div
          v-if="selectedOffice"
          class="fixed inset-0 bg-black/60 flex flex-col justify-center items-center p-6 z-50"
          ...
          >
            ...
            <div class="space-y-3">
              ...
              <div v-if="selectedOffice.phones?.mobile?.length" class="space-y-2">
                <div 
                  v-for="(phone, idx) in selectedOffice.phones.mobile" 
                  :key="`mobile-${idx}`"
              ...
              <div v-if="selectedOffice.phones?.landline?.length" class="space-y-2">
                <div 
                  v-for="(phone, idx) in selectedOffice.phones.landline" 
                  :key="`landline-${idx}`"
                  class="flex items-center gap-2 text-sm"
                >
              ...
              <!-- No Contact Info -->
              <p 
                v-if="!selectedOffice.phones?.mobile?.length && !selectedOffice.phones?.landline?.length" 
